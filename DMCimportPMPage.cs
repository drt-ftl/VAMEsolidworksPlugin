...
namespace qwe
{
    public class DMCimportPMPage
    {
        ...
        public const int button1ID = 2;
        public const int button2ID = 3;
        public const int checkbox1ID = 4;
        public const int option1ID = 5;
        public const int option2ID = 6;
        public const int option3ID = 7;
        public const int list1ID = 8;

        public const int selection1ID = 9;
        public const int num1ID = 10;
        public const int combo1ID = 11;
        #endregion

        public DMCimportPMPage(SwAddin addin)
        {
            userAddin = addin;
        ...
        protected void CreatePropertyManagerPage()
        {
            ...
            swPropertyPage = (IPropertyManagerPage2)iSwApp.CreatePropertyManagerPage("DMC Manager", options, handler, ref errors);
        ...
        protected void AddControls()
        {
            ...
            button1 = (IPropertyManagerPageButton)group1.AddControl(button1ID, controlType, "Browse...", align, options, "This is an example textbox");
            ...
            button2 = (IPropertyManagerPageButton)group1.AddControl(button2ID, controlType, "Button2", align, options, "This is an example textbox");
